...
> **🎯 АЛЬТЕРНАТИВА:** Для новых установок рассмотри **[→ прямое развертывание на SSD](ssd-direct-setup.md)**
>
> Вместо сложной миграции с SD → SSD, можно прошить Ubuntu образ **сразу на SSD**:
> - Проще: 3-4 шага вместо 8-10
> - Надёжнее: нет проблем с cmdline.txt, cgroup, etc.
> - Чище: свежая система без артефактов миграции
>
> **Миграция с SD нужна только если:** у тебя уже настроенная система на SD которую нужно перенести.
